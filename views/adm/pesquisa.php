          ...
          <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" onclick="location. href= '../adm/NovaSenhaPrincipal.php'">Alterar Senha</a>
...
?>
 ...
 <form class="form-inline my-2 my-lg-0" method="post" action="pesquisa.php">
	...
	<strong> CPF: </strong> <input name = "cpf" id = "pesquisa2" class="form-control form-control-sm" type="search" placeholder="CPF" aria-label="Pesquisar" autocomplete="off" onkeypress="$(this).mask('000.000.000-00')">
    ...
    <p>
    <p>
	<form name="searchform" method="post" action="gerarplanilha.php">
...
try {
        include_once '../../models/adm/processa.php';
        $pesq = new pesquisa();
        $pesq->pesquisaProfessores($_POST['cpf'], $_POST['nome'], $_POST['setor']);
}catch (Exception $e)
    { 
