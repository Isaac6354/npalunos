...
<div id='newquest'>
<button class = "btn btn-info btn-sm" data-toggle="modal" data-target="#newQuest">Novo Questionario?</button>
</div>
<div>              
         <table class="table table-hover" id="tableQuest">
    <tr>
        <th scope="col" width= '1 px'>Código:</th>
        <th scope="col" >Título:</th>
        <th scope="col" width= '10 px'>Inicio: </th>
        <th scope="col" width= '15 px'>Validade:</th>
        <th scope="col" width= '10 px'>Status:</th>
        <th scope="col">Ações:</th>
    </tr>   
<?php 
include_once '../../models/professor/metodosProfessor.class.php';
$quest = new professor();
    Try
    {
        $quest->getQuestionarioAtivo($_SESSION['usuario']);
    }
    catch (Exception $e)
    {
        echo "Erro $e";
...
?>        
 ...
 <div class="modal fade bd-example-modal-xl" id = "newQuest" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
    
    <form name="form1" method="post"  action="../../models/professor/addNewQuest.php">
		<div class="container-fluid">
		<div class="Cadastro">
		<div class="container theme-showcase" role="main">
		<center>
<div id="tituloQuest">
<p></p><h3> Novo Questionário:</h3><p></p> 
</div>
<div class="row">
 <div class="form-group col-md-6">
   <label for="campo1"><strong>Titulo:</strong></label>
   <input name="titulo" type="text" class="form-control" id="titulo" placeholder="Titulo do questionário" required>
 </div>
  <div class="form-group col-md-6">
   <label for="campo1"><strong>Publico Alvo:</strong></label>
   <input name="publico_alvo" type="text" class="form-control" id="publico_alvo" placeholder="Publico Alvo do questionário" required>
 </div>
  <div class="form-group col-md-4">
   <label for="campo1"><strong>Data de inicio do questionário:</strong></label>
   <input name="inicio" type="date" class="form-control" id="inicio" placeholder="00/00/0000">
 </div>
 
  <div class="form-group col-md-4">
   <label for="campo1"><strong>Data de validade:</strong></label>
   <input name="validade" type="date" class="form-control" id="validade" placeholder="00/00/0000">
 </div>
 <div class="form-group col-md-4">
 <label for="campo1"><strong>Deseja receber Notificações?</strong></label>
	<div class="form-check">
          <input class="form-check-input" type="radio" name="aviso" id="aviso" value="1">
          	<label class="form-check-label" for="gridRadios1">
            	Sim
          	</label>
    </div>
        <div class="form-check">
          <input class="form-check-input" type="radio" name="aviso" id="aviso" value="0" required>
