        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" src="../../util/mage/conta.PNG" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
<div>
      ...
      <div class="container-fluid">
        <form name="form42" method="post" action="../../models/professor/AlteraSenhaPrincipal.php" onsubmit = "return validaSenha(); validaSenhaAtual()">
<div class="Cadastro">
